...
JS
            ...
            $this->getView()->registerJs('var extra_config_'.$id.' = (typeof '.$id.'_config !== "undefined") ? '.$id.'_config : {};');
            $this->getView()->registerJs($globalVariable . 'jQuery("#' . $id . '").DataTable(Object.assign(' . Json::encode($this->getParams()) . ', extra_config_'.$id.'));');
        }
    }
